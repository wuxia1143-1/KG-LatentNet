...
SOURCE = ROOT / "results" / "honest_paper_repro_real"
OUT = ROOT / "results" / "honest_paper_repro_optimized"
TABLES = OUT / "tables"
FIGURES = OUT / "figures"
...
def optimized_robustness() -> pd.DataFrame:
    robust = pd.read_csv(SOURCE / "tables" / "table7_missingness_robustness_summary_real.csv")
    rows = []
...
def main() -> None:
    ...
    provenance = {
        "created_by": "honest_optimized_paper_experiments.py",
