...
OUT = ROOT / "results" / "honest_paper_repro_validation_top"
...
def main() -> None:
    ...
    provenance = {
        "created_by": "honest_real_final_outputs_validation_top.py",
        "test_set_used_for_kg_selection": False,
        "kg_selection": "global five-fold validation selection; residual branch selected when it has any mean validation MAE gain over best calibrated anchor",
